    ...
    <div>
      ...
      <form onSubmit={submit} className="mt-5 space-y-5">
        ...
        <div className="flex gap-3">
          <button
            type="submit"
            className="rounded-lg bg-slate-900 px-5 py-2.5 text-sm font-medium text-white hover:bg-slate-800 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-slate-900"
          >
            {t('create.submit')}
          </button>
          <Link
